...
const CardSwap = ({
  ...
  useEffect(() => {
    ...
    const swap = () => {
      ...
      tl.to(elFront as gsap.core.Tween, {
        y: "+=500",
      ...
      rest.forEach((idx, i) => {
        ...
        tl.set(el as gsap.core.Tween, { zIndex: slot.zIndex }, "promote");
        tl.to(
          el as gsap.core.Tween,
          {
            x: slot.x,
            y: slot.y,
            z: slot.z,
      ...
      tl.call(
        () => {
          gsap.set(elFront as gsap.core.Tween, { zIndex: backSlot.zIndex });
        },
        undefined,
        "return"
      );
      tl.set(elFront as gsap.core.Tween, { x: backSlot.x, z: backSlot.z }, "return");
      tl.to(
        elFront as gsap.core.Tween,
        {
          y: backSlot.y,
