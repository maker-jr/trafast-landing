    ...
    <section style={{ background: "#FBF8F2", color: "#2A211B" }}>
      ...
      >
        ...
        >
          ...
          >
            Offline is the safety net. This is the app you use all day.
          </div>
        </div>
        ...
        <div data-fanwrap="" data-m="fan" style={fanWrap}>
          ...
          <div
            data-fan="0"
            style={fanCardStyle(0, "#2A211B", "#FBF8F2", "0 40px 90px rgba(42,33,27,0.14)", 24)}
          >
            <div style={fanHeading}>One home for your money.</div>
            <FanArt>
              <span
                style={{
                  position: "absolute",
          ...
          <div
            data-fan="1"
            style={fanCardStyle(1, "#F3EDE2", "#2A211B", "0 40px 90px rgba(42,33,27,0.14)", 24)}
          >
            <div style={fanHeading}>Send and receive in seconds. Any bank, any tag.</div>
            <FanArt>
              <div
                style={{
                  position: "absolute",
          ...
          <div
            data-fan="2"
            style={fanCardStyle(2, "#F5B32C", "#2A211B", "0 40px 90px rgba(42,33,27,0.14)", 24)}
          >
            <div style={fanHeading}>Pay bills, buy airtime, scan any QR.</div>
            <FanArt>
              <div
                style={{
                  position: "absolute",
